...
#under the License.
require 'translator'
require File.join(File.dirname(__FILE__), "lib", "foradian_mess_plugin")
require 'acts_as_taggable'

FedenaPlugin.register = {
  :name=>"foradian_mess_plugin",
  :description=>"Fedena Mess Module",
  :auth_file=>"config/mess_auth.rb",
  :more_menu=>{:title=>"library_text",:controller=>"library",:action=>"index",:target_id=>"more-parent"},
  :sub_menus=>[{:title=>"manage_books",:controller=>"books",:action=>"index",:target_id=>"foradian_mess_plugin"},
    {:title=>"search_book_text",:controller=>"library",:action=>"search_book",:target_id=>"foradian_mess_plugin"},
    {:title=>"return_book",:controller=>"book_movement",:action=>"return_book",:target_id=>"foradian_mess_plugin"},
    {:title=>"issue_books",:controller=>"book_movement",:action=>"direct_issue_book",:target_id=>"foradian_mess_plugin"},
    {:title=>"library_setting_text",:controller=>"library",:action=>"card_setting",:target_id=>"foradian_mess_plugin"},
    {:title=>"movement_log_index",:controller=>"library",:action=>"movement_log",:target_id=>"foradian_mess_plugin"},
    {:title=>"book_renewal",:controller=>"book_movement",:action=>"renewal",:target_id=>"foradian_mess_plugin"}],
  :dashboard_menu=>{:title=>"mess_text",:controller=>"mess",:action=>"index",\
      :options=>{:class => "option_buttons", :id => "library_button", :title => "manage_mess"}},
